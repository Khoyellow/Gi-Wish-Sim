const e = "Genshin Impact Wish Simulator",
    t = "Character",
    a = "Weapon",
    n = "Vision",
    i = "Anemo",
    ...
    v = "Confirm",
    S = "Cancel",
    P = "All assets used in this site are owned by miHoYo.",
    I = "This is purely a fan made Application, enjoy it !",
    C = "Press anywhere in the blank area to continue",
    W = "Instructions to Install to Home Screen/Desktop",
    F = "Share",
    T = "Take Picture",
    x = "Capturing",
    A = "Reward for first share : {qty}",
    B = "Version",
    E = "Donate",
    N = {
        wishTitle: "Wish",
    ...
    z = {
        ...
        clearCache: "Clear Caches ( {size} ) ? You will redownload the cached assets after this action!",
        ...
        removeKey: "Remove AdKey",
        removeKeyConfirm: "Are You sure to remove the current adKey ? You need to enter a new key to remove the future ads!",
        ...
        adFreeUser: "You're enjoying Simulator Without Ads !",
        inputKeyPlaceholder: "Enter Key",
        inputKeyTxt: "Input the Key to Remove Ads !",
...
export {
    i as anemo, u as bow, S as cancelButton, x as capturing, d as catalyst, t as character, p as claymore, v as confirmButton, g as connectionFailed, o as cryo, G as
    default, r as dendro, O as details, P as disclaimer, E as donate, s as electro, f as extra, I as fanmade, c as geo, D as history, l as hydro, W as installInstruction, L as inventory, z as menu, y as obtained, k as outfit, w as polearm, C as pressToContinue, h as pyro, A as rewardFirstShare, T as screenshot, F as share, R as shop, m as sword, e as title, B as version, n as vision, b as waiting, a as weapon, N as wish
};